...
$objStudent = new Student();
		...
		$result = $objStudent->updateStudent($student_id, $attendance_date, $attendance_session, $status,$remarks,$student_attendance_id) ;
								...
								<table border="0" width="100%">
									...
									<tr><td valign="top" align="center">
										<table border="0" height ="250px" width="60%">
											...
											<td width="2%"></td>
											<td width="30%">
												<input type="text" name="student_attendance_id" 
